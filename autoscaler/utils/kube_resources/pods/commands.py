...
from autoscaler.utils.kube_resources.utils import construct_pod
...
def get_pods(namespace="autoscaling"):
    if namespace == "all":
...
def get_pod(pod_name, namespace="autoscaling"):
...
def delete_pod(pod_name, namespace="autoscaling"):
