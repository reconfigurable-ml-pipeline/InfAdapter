...
from autoscaler.utils.kube_resources.utils import construct_hpa
from autoscaler.utils.kube_resources import autoscaling_api as api
...
def get_hpas(namespace="autoscaling"):
    if namespace == "all":
...
def get_hpa(autoscaler_name, namespace="autoscaling"):
...
def delete_hpa(name, namespace="autoscaling"):
